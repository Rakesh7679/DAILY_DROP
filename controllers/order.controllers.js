...
import { incrementOrderCount } from "./item.controllers.js"
...
export const placeOrder = async (req, res) => {
    try {
        ...
        // Increment order count for trending
        cartItems.forEach(item => {
            incrementOrderCount(item.id)
        })
...
export const getMyOrders = async (req, res) => {
    try {
        ...
        if (user.role == "user") {
            ...
            // Delivery boy ke liye empty array return karo
            // Delivery boys ko DeliveryBoy component me hi orders dikhte hain
            return res.status(200).json([])
        }
